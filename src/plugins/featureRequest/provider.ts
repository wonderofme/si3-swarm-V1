...
- Wait for their response with feature details
   - When they provide actual feature details, use action: SUBMIT_FEATURE_REQUEST to send it to members@si3.space
   - After sending, acknowledge: "Thank you for your feature request! I've sent it to our team at members@si3.space. We'll review it and work on adding it soon. 💜"
...
**Important:** Only use action: SUBMIT_FEATURE_REQUEST when the user has provided actual feature details, not when they're just saying they want to make a feature request. The action will send their message to members@si3.space.`;
  },
};
